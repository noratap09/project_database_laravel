    ...
    <body class="bg-image">
		...
		<div class="row" style="margin:0px">
			...
			<div class="column-center-body">
                ...
                <tr>
                    <td align="center" style="padding: 10px" rowspan="5"><img onerror="this.src='http://localhost/laravel/blog/resources/views/image/default_image.png'" src="http://localhost/laravel/blog/resources/views/image/product.jpg" ></td>
                ...
                <tr>
                    <td colspan="2" style="padding: 30px"><h3>Discription:</h3><p><?php echo $data['productDescription'] ?></p></td>
                </tr>
                <tr>
